...
files_path_1 = '/home/rnov/tfg/dropboxApi/encrypt/'
chunks_path_1 = '/home/rnov/tfg/dropboxApi/encrypt/chunks/'
key_path_1 = '/home/rnov/tfg/aesrypt/secret.key'
key_path_2 = '/home/rnov/tfg/aesrypt/secret2.key'
...
def encrypt_files(files_path, key_path, chunks_path):
    ...
    """
    listFiles = os.listdir(files_path)
    ...
    listFiles = os.listdir(split_path)
    for chunks in listFiles:
        if chunks.rfind('-0') > -1:
            #print chunks
...
def decrypt_chunks_parallel(files_path, key_path_chunk, dst_path=None):
    """
    decrypt and merge chunk files from given path to given directory/ies
...
def decrypt_to_file_parallel(files_path, key_path, dst_path=None):
    """
    decrypts and merges chunks from given path to given directory with a given key launching parallel processes
    :param files_path: str chunks source path
    :param key_path: str key's path
    :param dst_path: str destiny path
    :return:
...
def aux_decrypt():
    """
    auxiliary function that helps debugging decrypting functions from split_encrypt module
    :return:
    """
